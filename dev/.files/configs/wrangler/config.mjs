...
import getSettings from './resources/settings.mjs';
...
export default async () => {
    ...
    const workerProjectConfig = {
        ...(['cma'].includes(u.pkgBuildAppType) && ['cfw'].includes(u.pkgBuildTargetEnv)
            ? {
                  // Worker account ID.
                  ...
                  main: './' + path.relative(u.projDir, settings.defaultWorkerMainEntryFile),
    ...
    const pagesProjectConfig = {
        ...(['spa', 'mpa'].includes(u.pkgBuildAppType) && ['cfp'].includes(u.pkgBuildTargetEnv)
            ? {
                  ...
                  pages_build_output_dir: './' + path.relative(u.projDir, settings.defaultPagesBuildOutputDir),
