 ...
 * @see https://vite.dev/config/build-options.html#build-rollupoptions
 */
 ...
 */
export default async ({ a16sDir, appType, appEntries, minifyEnable, sideEffects }) => {
    return {
        rollupConfig: {
            ...
            treeshake: {
                ...
                moduleSideEffects: (id /*, external */) => {
                    return sideEffects.includes('./' + path.relative(u.projDir, id));
            ...
            external: [
                ...
                ...Object.keys(u.pkgPeerDependencies).map((pkgName) => new RegExp('^' + $str.escRegExp(pkgName) + '(?:$|[/?])', 'u')),
            ],
            output: {
                ...
                entryFileNames: (entry) => {
                    ...
                    return path.join(path.relative(u.srcDir, path.dirname(entry.facadeModuleId)), '[name].js');
                },
                ...
                // By default, in library mode, Vite ignores `build.assetsDir`.
                // This prevents that by enforcing a consistent location for chunks and assets.
                assetFileNames: (/* asset */) => path.join(path.relative(u.distDir, a16sDir), '[name]-[hash].[ext]'),
