 ...
 *
 * @note This expression supports the `/g` flag, in case that's ever needed, but we don't currently use it.
 *       i.e., Our goal is simply to preserve the *first* `<custom:start></custom:end>` block found in any given dotfile.
 */
